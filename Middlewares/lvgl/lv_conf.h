...
#define LV_COLOR_DEPTH 16//��ɫ���Ϊ16λ
 ...
 */
#define LV_USE_STDLIB_MALLOC    LV_STDLIB_BUILTIN//ʹ��LVGL�������ڴ���亯��
 ...
 * - LV_STDLIB_CUSTOM:      Implement the functions externally
 */
#define LV_USE_STDLIB_STRING    LV_STDLIB_BUILTIN//ʹ��LVGL�������ַ�����������
 ...
 * - LV_STDLIB_CUSTOM:      Implement the functions externally
 */
#define LV_USE_STDLIB_SPRINTF   LV_STDLIB_BUILTIN//ʹ��LVGL�������ַ�����ʽ������
...
#if LV_USE_STDLIB_MALLOC == LV_STDLIB_BUILTIN//���ʹ��LVGL�������ڴ���亯��
    /** Size of memory available for `lv_malloc()` in bytes (>= 2kB) */
    #define LV_MEM_SIZE (64 * 1024U)         //64KB

    /** Size of the memory expand for `lv_malloc()` in bytes */
    #define LV_MEM_POOL_EXPAND_SIZE 0//�ڴ����չ��СΪ0
...
#define LV_DEF_REFR_PERIOD  20      //Ĭ��ˢ������Ϊ33ms

/** Default Dots Per Inch. Used to initialize default sizes such as widgets sized, style paddings.
 * (Not so important, you can adjust it to modify default sizes and spaces.) */
#define LV_DPI_DEF 130              //Ĭ��DPIΪ130
...
#define LV_USE_OS   LV_OS_FREERTOS //ʹ��FreeRTOS����ϵͳ
...
#define LV_DRAW_BUF_STRIDE_ALIGN                1 //���ƻ������ж���Ϊ1�ֽ�

/** Align start address of draw_buf addresses to this bytes*/
#define LV_DRAW_BUF_ALIGN                       4 //���ƻ�������ַ����Ϊ4�ֽ�

/** Using matrix for transformations.
 * Requirements:
 * - `LV_USE_MATRIX = 1`.
 * - Rendering engine needs to support 3x3 matrix transformations. */
#define LV_DRAW_TRANSFORM_USE_MATRIX            0 //��ʹ�þ���任
...
#define LV_DRAW_LAYER_SIMPLE_BUF_SIZE    (24 * 1024)     //��ͼ�㻺������СΪ24KB
...
#define LV_DRAW_LAYER_MAX_MEMORY 0   //��ͼ��ͱ任ͼ�������ڴ�Ϊ0����������

/** Stack size of drawing thread.
 * NOTE: If FreeType or ThorVG is enabled, it is recommended to set it to 32KB or more.
 */
#define LV_DRAW_THREAD_STACK_SIZE    (8 * 1024)         //�����߳�ջ��СΪ8KB
...
#define LV_DRAW_THREAD_PRIO LV_THREAD_PRIO_HIGH //�����߳����ȼ�Ϊ��

#define LV_USE_DRAW_SW 1 //ʹ����������
#if LV_USE_DRAW_SW == 1 
    /*
    ...
    #define LV_DRAW_SW_I1_LUM_THRESHOLD 127 //������ɫ��ʽ�п�������Ϊ��Ծ��������ֵΪ127

    /** Set number of draw units.
     *  - > 1 requires operating system to be enabled in `LV_USE_OS`.
     *  - > 1 means multiple threads will render the screen in parallel. */
    #define LV_DRAW_SW_DRAW_UNIT_CNT    1 //�������Ƶ�Ԫ����Ϊ1

    /** Use Arm-2D to accelerate software (sw) rendering. */
    #define LV_USE_DRAW_ARM2D_SYNC      0 //��ʹ��Arm-2Dͬ������

    /** Enable native helium assembly to be compiled. */
    #define LV_USE_NATIVE_HELIUM_ASM    0 //��ʹ�ñ���Helium���
    ...
    #define LV_DRAW_SW_COMPLEX          1 //ʹ�ø�����Ⱦ��
    ...
    #define  LV_USE_DRAW_SW_ASM     LV_DRAW_SW_ASM_NONE //��ʹ���Զ�����������ASM
    ...
    #define LV_USE_DRAW_SW_COMPLEX_GRADIENTS    0 //��ʹ�ø�����Ⱦ���ĸ��ӽ���

#endif

/*Use TSi's aka (Think Silicon) NemaGFX */
#define LV_USE_NEMA_GFX 0 //��ʹ��NemaGFX
...
#define LV_FONT_CUSTOM_DECLARE \
    ...
    LV_FONT_DECLARE(noto_sans_sc_24)
 ...
 * OTHERS
 *==================*/
/* �ĵ���������λ���ҵ���https://docs.lvgl.io/master/auxiliary-modules/index.html . */
...
#if LV_USE_SYSMON
    /** ��ȡ���аٷֱȡ����磺uint32_t my_get_idle(void); */
    #define LV_SYSMON_GET_IDLE lv_os_get_idle_percent
    /** 1: ���� lv_os_get_proc_idle_percent ��ʹ�á�*/
    #define LV_SYSMON_PROC_IDLE_AVAILABLE 0
    #if LV_SYSMON_PROC_IDLE_AVAILABLE
        /** ��ȡӦ�ó���Ŀ��аٷֱȡ�
         * - ��Ҫ `LV_USE_OS == LV_OS_PTHREAD` */
