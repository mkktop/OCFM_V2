...
- 巴歇尔槽: Q = K × H^n（25种：1-17标准型 b=0.025~2.4m + 18-25大型 b=3.05~12.19m，标准 CJ/T 3008.3-1993）
- 三角堰: Q = K × (H+Kh)^2.5（90/60/45/30/22.5度，Kindsvater-Shen 方法，标准 ISO 1438）
- 矩形堰: Q = K × b_eff × (H+Kh)^1.5（0.5/1.0/1.5/2.0m，Francis 公式，标准 ISO 1438）
