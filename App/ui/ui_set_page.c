...
static const char *format_weekday(uint32_t val)
{
    ...
    return lang_get((lang_id_t)(LANG_F_WEEKDAY_SUN + val % 7));
}
...
static uint32_t rtc_get_weekday(void) { RTC_TimeData t; RTC_Time_Get(&t); return (t.weekDay + 5) % 7 + 1; }
...
static void rtc_set_weekday(uint32_t v) { RTC_TimeData t; RTC_Time_Get(&t); t.weekDay = (uint8_t)(v % 7 + 1); RTC_Time_Set(&t); }
...
static const set_item_t system_items[] = {
    ...
    {LANG_P_WATER_LEVEL_UP,  "m",    NULL, NULL, 0, 0, 0, 0, NULL,
                                       app_config_get_water_level_up,     app_config_set_water_level_up,    0.0f, 10.0f, 0.001f, 3},
    {LANG_P_WATER_LEVEL_DOWN,"m",    NULL, NULL, 0, 0, 0, 0, NULL,
                                       app_config_get_water_level_down,   app_config_set_water_level_down,  0.0f, 10.0f, 0.001f, 3},
...
static const set_item_t advanced_items[] = {
    ...
    {LANG_P_4MA_CAL,         "",     app_config_get_calibration_4ma,     app_config_set_calibration_4ma,   0, 7999, 1},
    {LANG_P_20MA_CAL,        "",     app_config_get_calibration_20ma,    app_config_set_calibration_20ma,  0, 7999, 1},
